...
const Footer: FC<React.ComponentProps<"footer">> = () => {
	return (
		<footer
			className="foot _theme_pariBet _mode_compact _state_compact _device_desktop"
			dangerouslySetInnerHTML={{ __html: html }}
		/>
	)
}

const html = `<style>/*! CSS Used from: Embedded */
a{background-color:transparent;}
/*! CSS Used from: Embedded */
*::-webkit-scrollbar{width:6px;}
*{scrollbar-width:thin;scrollbar-color:var(--thumb-background) var(--scrollbar-background);}
*::-webkit-scrollbar-track{background:var(--scrollbar-background);}
*::-webkit-scrollbar-thumb{background-color:var(--thumb-background);border-radius:6px;border:3px solid var(--scrollbar-background);}
